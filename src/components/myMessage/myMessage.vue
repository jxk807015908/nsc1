      ...
      <el-container>
        <div class="detail" v-if="checkedIndex!==''">
          <!--<div v-if="remindList[checkedIndex].messageType==='1'">-->
            <chatWindow v-if="remindList[checkedIndex].messageType==='1'" :chatId="remindList[checkedIndex].fromId" :chatType="remindList[checkedIndex].remark==='friend'?1:2"></chatWindow>
          <!--</div>-->
