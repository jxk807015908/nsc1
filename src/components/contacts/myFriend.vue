            ...
            <div class="input-menu">
              ...
              <el-popover
                ...
                <div v-loading="isLoadingImage">
                  <!--<img v-for="(item,index) in expressArr" :src="'data:image/png;base64,'+item.img" alt="" @click="clickExpress(index)">-->
  ...
  export default {
    ...
    mounted() {
      ...
      (async () => {
        ...
        if (this.$route.params.friendId !== undefined) {
          this.curFriendId = this.$route.params.friendId;
          let belongGroup=this.friendGroup.filter(obj=>obj.content.some(obj2=>obj2.friendId===this.$route.params.friendId))[0];
          ...
          // this.getFriendMessage(this.$route.params.friendId,[belongGroup.value,this.$route.params.friendId]);
        }
      })();
          ...
          if (value) {
            ...
            this.$store.state.socket.on('getMessage', (item) => {
              ...
              button[0].onclick=()=>{
                ...
                // this.getFriendMessage(item.from,[belongGroup.value,item.from]);
